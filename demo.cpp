...
//{
//    
//    // Create a new window 900 by 700 in size
...
//}
//
//void clearWindow(window& inputWindow)
//{
//	// Set the brush and pen white so we can clear the background
//	inputWindow.SetPen(WHITE, 0);
//	inputWindow.SetBrush(WHITE);
...
//
//
//void simpleDemoMoveCircle()
//{
//
//	int centx=200, centy=250, rad = 40;
//
//	window w(1200, 700,5,5);
//	w.ChangeTitle("Hello, Lib test");
//
//	w.SetPen(RED, 6);
//	w.DrawLine(50, 400, 500, 400);
//	w.SetPen(BLUE, 6);
//	w.SetBrush(YELLOW);
//	w.DrawCircle(centx, centy, rad);
//	WaitNClear(w);
//
//	while (centy + rad < 400)
//	{
